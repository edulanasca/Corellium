...
public interface Kernel32 extends StdCallLibrary {
    ...
    public class SYSTEM_POWER_STATUS extends Structure {
        ...
        public String getBatteryFlagString() {
            switch (BatteryFlag) {
                case (1): return "Alto, más del 66%";
                case (2): return "Bajo, menos del 33%";
                case (4): return "Crítico, menos del 5%";
        ...
        public String getBatteryLifePercent() {
            return (BatteryLifePercent == (byte) 255) ? "Desconocido" : BatteryLifePercent + "%";
        }
        ...
        public String getBatteryLifeTime() {
            return (BatteryLifeTime == -1) ? "Desconocido" : BatteryLifeTime + " segundos";
        }
        ...
        public String getBatteryFullLifeTime() {
            return (BatteryFullLifeTime == -1) ? "Desconocido" : BatteryFullLifeTime + " segundos";
        }
